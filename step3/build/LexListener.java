...
public interface LexListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LexParser#string_decl_list}.
	 * @param ctx the parse tree
	 */
	void enterString_decl_list(@NotNull LexParser.String_decl_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link LexParser#string_decl_list}.
	 * @param ctx the parse tree
	 */
	void exitString_decl_list(@NotNull LexParser.String_decl_listContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link LexParser#func_decl_tail}.
	 * @param ctx the parse tree
	 */
	void enterFunc_decl_tail(@NotNull LexParser.Func_decl_tailContext ctx);
	/**
	 * Exit a parse tree produced by {@link LexParser#func_decl_tail}.
	 * @param ctx the parse tree
	 */
	void exitFunc_decl_tail(@NotNull LexParser.Func_decl_tailContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link LexParser#var_decl_list}.
	 * @param ctx the parse tree
	 */
	void enterVar_decl_list(@NotNull LexParser.Var_decl_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link LexParser#var_decl_list}.
	 * @param ctx the parse tree
	 */
	void exitVar_decl_list(@NotNull LexParser.Var_decl_listContext ctx);
	/**
