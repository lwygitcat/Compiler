...
param_decl        
	: var_type id {  currscope = symtab.popScope();
                     currscope.addsymbol($id.text, $var_type.text, null);
                     symtab.pushScopeBack(currscope); }
	;
...
aug_else_part 
    : 	{ count = count + 1;
           symtab.pushScope("BLOCK "+ String.valueOf(count));} 'ELSE'  decl aug_stmt_list aug_else_part
    | /* */
    ;
